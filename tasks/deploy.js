...
const envVariables = {
  NODE_ENV: env,
  AWS_ACCESS_KEY_ID: process.env.OHSOYKA_DO_SPACE_KEY,
  AWS_SECRET_ACCESS_KEY: process.env.OHSOYKA_DO_SPACE_SECRET,
  OHSOYKA_JWT_SECRET: process.env.OHSOYKA_JWT_SECRET,
};
